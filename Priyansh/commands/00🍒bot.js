...
if ((event.body.toLowerCase() == "satting karva de") || (event.body.toLowerCase() == "satting kara")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bos")) {
     return api.sendMessage("https://www.facebook.com/share/17WfouwH1u/Accoʋŋtʌŋt Aŋsʜ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is pagla larka. He Gives his name pagala everywharehttps://www.facebook.com/profile.php?id=61586328547946&mibextid=ZbWKwL", threadID);
   };
